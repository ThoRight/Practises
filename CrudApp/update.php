...
<body>
    <header class="d-flex justify-content-center py-3">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="update.php" class="nav-link active">Update User</a></li>
    ...
    <div class="container">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <?php if ($page > 1) : ?>
                    <li class="page-item">
                        <a class="page-link" href="update.php?page=<?php echo $page - 1; ?>" aria-label="Previous">
                ...
                <?php if ($page > 1) : ?>
                    <li class="page-item">
                        <a class="page-link" href="update.php?page=<?php echo $page - 1; ?>"><?php echo $page - 1; ?></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($page < $total_pages) : ?>
                    <li class="page-item">
                        <a class="page-link" href="update.php?page=<?php echo $page + 1; ?>" aria-label="Next">
